class Solution {
    ...
    public boolean predictTheWinner(int[] nums) {
        ...
        // If the max score difference for Player 1 is >= 0, Player 1 wins or ties.
    ...
    private int maxDiff(int[] nums, int left, int right) {
        ...
        // Choose the left element or the right element and subtract the opponent's optimal result
